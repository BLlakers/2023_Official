...
double scale = 250;
double offset = -25;
AnalogPotentiometer pressureTransducer = new AnalogPotentiometer( 2, scale, offset); //Analogln port

DoubleSolenoid exampleDoublePH = new DoubleSolenoid(30, PneumaticsModuleType.REVPH, 0, 7); //NO ROBOT CODE THIS IS SOLENOID PORT
...
Compressor phCompressor = new Compressor(Constants.PHChannel, PneumaticsModuleType.REVPH); //No robot code here

...
public class AutoCommand extends CommandBase {
  ...
  public AutoCommand(DriveTrain _DriveTrain, int _AutoMode) { // Creates a contrusctor for auto command (How things get
                                                              // set up)
  ...
  public void initialize() { // Runs once at the beginning of the command
    ...
    m_DriveTrain.brDrive.setIdleMode(CANSparkMax.IdleMode.kBrake); // Lines 30-33 Setting SparkMax Mode (Break =
                                                                   // completely still) (Coast = Move with extra
                                                                   // momentum)
  ...
  public void execute() { // Runs multiple times
    ...
    if (m_AutoMode == 3) {
      ...
      if ((w1ca > align_tol && w1ca < (180 - align_tol)) || (w1ca > (180 + align_tol) && w1ca < (360 - align_tol))) { // If
                                                                                                                      // The
                                                                                                                      // front
                                                                                                                      // right
                                                                                                                      // wheel
                                                                                                                      ...
                                                                                                                      // wheels
        m_DriveTrain.drive(() -> 0, () -> 0, () -> 0); // says not to drive
      } else if ((w2ca > align_tol && w2ca < (180 - align_tol))
          || (w2ca > (180 + align_tol) && w2ca < (360 - align_tol))) { // If The front left wheel is > 7 degress and <
                                                                       // 173 OR > 187 and < 353 it will tell the robot
                                                                       // to not move foward and it will re center the
                                                                       // wheels
        m_DriveTrain.drive(() -> 0, () -> 0, () -> 0); // says not to drive
      } else if ((w3ca > align_tol && w3ca < (180 - align_tol))
          || (w3ca > (180 + align_tol) && w3ca < (360 - align_tol))) { // If The back left wheel is > 7 degress and <
                                                                       // 173 OR > 187 and < 353 it will tell the robot
                                                                       // to not move foward and it will re center the
                                                                       // wheels
        m_DriveTrain.drive(() -> 0, () -> 0, () -> 0); // says not to drive
      } else if ((w4ca > align_tol && w4ca < (180 - align_tol))
          || (w4ca > (180 + align_tol) && w4ca < (360 - align_tol))) { // If The back right wheel is > 7 degress and <
                                                                       // 173 OR > 187 and < 353 it will tell the robot
                                                                       // to not move foward and it will re center the
                                                                       // wheels
        m_DriveTrain.drive(() -> 0, () -> 0, () -> 0); // says not to drive
